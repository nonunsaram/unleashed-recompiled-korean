...
import bsdiff4
O=R/'Build/GameBanana-0.4.16/UnleashedKorean';D=O/'Support/Patches';D.mkdir(parents=True,exist_ok=True)
P=R/'Build/FieldMission-v056';B=R/'UnleashedRecomp-Windows/korean-mod-backup-v040'
...
(O/'Support/manifest.json').write_text(json.dumps({'version':'0.4.16','gameVersion':'Unleashed Recompiled v1.0.3 Windows x64','files':files},ensure_ascii=False,indent=2),encoding='utf8')
