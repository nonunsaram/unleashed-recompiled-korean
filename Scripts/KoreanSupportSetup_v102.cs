...
public class SupportWindow : Form {
    ...
    public SupportWindow(string folder) {
        package=folder;Text="언리쉬드 리컴파일드 한국어 패치 · 1.0.2";ClientSize=new Size(780,625);Font=new Font("맑은 고딕",10);StartPosition=FormStartPosition.CenterScreen;FormBorderStyle=FormBorderStyle.FixedDialog;MaximizeBox=false;AutoScaleMode=AutoScaleMode.Dpi;BackColor=Color.FromArgb(246,247,249);
